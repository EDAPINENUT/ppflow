...
> - The newly trained ppflow as `pretrained.pt` with the processed benchmark datasets `pepglad_filter.zip` can be downloaded from [Google Drive](https://drive.google.com/drive/u/0/folders/1ce5DVmZz0c-p3PKrGDQoU_C9MD3cWLNq). It is the version of ppflow with the data provided from [PepGlad](https://github.com/THUNLP-MT/PepGLAD/tree/main). The performance is different from the reported ones since the training data is different.
