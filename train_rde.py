...
from ppflow.utils.train import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./configs/train/rde.yml')
    ...
    parser.add_argument('--finetune', type=str, default='./pretrained/RDE.pt')
